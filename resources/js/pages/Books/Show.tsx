...
export default function Show({ bookEdition, copies_left, otherEditionsOfBook, otherBookEditionsByAuthor }: ShowProps) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex min-h-full h-full w-full flex-col gap-8 md:flex-row">
                <div>
                ...
                <div className="acrylic flex-1 min-w-0 min-h-0 rounded-2xl p-6 shadow-xl md:p-8 flex flex-col">
                    ...
                    <div className='relative w-full min-h-0 h-0 flex-1 overflow-y-auto'>
